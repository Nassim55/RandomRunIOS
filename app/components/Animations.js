import { add, block, call, cond, eq, set, spring, startClock, stopClock, useValue } from "react-native-reanimated";
import { State } from 'react-native-gesture-handler';
import { snapPoint, useClock } from "react-native-redash/lib/module/v1";

export const useSpring = ({ value, velocity, state: gestureState, snapPoints, onSnap }) => {
